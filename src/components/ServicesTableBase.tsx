import { Badge, ButtonInline, Card, Table, TableBody, TableCell, TableHead, TableHeaderCell, TableRow, Title } from '@tremor/react';
import * as RiIcons from "react-icons/ri";
import { Link } from "react-router-dom";

export const ServicesTableBase = (props: any) => {
    return (
        <Card>
            <Link to='/dashboard'>
                <ButtonInline
            ...
            <Table marginTop='mt-5'>
                ...
                <TableBody>
                    {!props.loading && props.dataset.services && props.dataset.services.map((item: any) => (
                        <TableRow>
